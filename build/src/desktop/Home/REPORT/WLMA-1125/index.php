...
<html>
    <head>
        <base href="/rmr/build/src/desktop/Home/REPORT/WLMA-1125/">
        <meta charset="utf-8">
        ...
        <link href="../../../../../stylesheets/stylesheet-rmr-home-report-wlma1125.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="container sidebar-blue" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse sidebar-fixed">
                ...
                <ul class="nav nav-list">
                    ...
                    <!-- END Search Form -->
                        ...
                        <ul class="submenu">
                            <li class="">
                                <a href="./REPORT-001/">สถานะการซ่อมท่อจ่ายน้ำ</a>
                            </li>
                        </ul>
                        <!-- END Submenu -->
                    </li>
            ...
            <!-- END Sidebar -->
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i>   WLMA-1125</h1>
                        <h4>รายงานผลการติดตามสถานะการรับส่งข้อมูลระหว่าง WLMA-1125</h4>
                    </div>
                </div>
                <!-- END Page Title -->
        ...
        <script src="../../../../../javascripts/javascript-rmr-home-report-wlma1125.js" type="text/javascript"></script>
