...
<html>
    <head>
        <base href="/rmr/build/src/desktop/Home/REPORT/WLMA-GIS/REPORT-001/">
        <meta charset="utf-8">
        ...
        <link href="../../../../../../stylesheets/stylesheet-rmr-home-report-wlma_gis-report001.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="container sidebar-blue" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse sidebar-fixed">
                ...
                <ul class="nav nav-list">
                    ...
                    <!-- END Search Form -->
                        ...
                        <ul class="submenu">
                            <li class="active">
                                <a href="./">พิกัดตำแหน่งจุดท่อแตกรั่ว</a>
                            </li>
                        </ul>
                        <!-- END Submenu -->
                    </li>
            ...
            <!-- END Sidebar -->
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i>   พิกัดตำแหน่งจุดแตกรั่ว</h1>
                        <h4>รายงานพิกัดตำแหน่งจุดแตกรั่ว</h4>
                    </div>
                </div>
                <!-- END Page Title -->
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li class="active">พิกัดตำแหน่งจุดแตกรั่ว</li>
                    </ul>
                </div>
                <!-- END Breadcrumb -->
        ...
        <script src="../../../../../../javascripts/javascript-rmr-home-report-wlma_gis-report001.js" type="text/javascript"></script>
