...
<html>
    <head>
        <base href="/rmr/build/src/desktop/Home/RMR/ReportCost/">
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>RMR - สรุปงบประมาณ</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

        <link href="../../../../../stylesheets/stylesheet-home-rmr-reportCost.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="container sidebar-blue" id="main-container">
            ...
            <div id="main-content" >
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i>   รายงานงบประมาณ</h1>
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li class="active">รายงานงบประมาณ</li>
                    </ul>
                </div>
                <!-- END Breadcrumb -->
        ...
        <script src="../../../../../javascripts/javascript-home-rmr-reportCost.js" type="text/javascript"></script>
