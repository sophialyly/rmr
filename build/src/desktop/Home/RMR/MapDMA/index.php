...
<html>
    <head>
        <base href="/rmr/build/src/desktop/Home/RMR/MapDMA/">
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>RMR - แผนที่ DMA</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

        <link href="../../../../../stylesheets/stylesheet-home-rmr-mapDMA.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="container" id="main-container">
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i>   แผนที่ DMA</h1>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <p>It's easy as just remove <code>#sidebar</code> code section.</p>
                            </div>
                        </div>
        ...
        <script src="../../../../../javascripts/javascript-home-rmr-mapDMA.js" type="text/javascript"></script>
