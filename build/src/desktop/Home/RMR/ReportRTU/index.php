...
<html>
    <head>
        <base href="/rmr/build/src/desktop/Home/RMR/ReportRTU/">
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>RMR - แสดงข้อมูล RTU ที่ใช้งาน</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

        <link href="../../../../../stylesheets/stylesheet-home-rmr-reportRTU.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="container sidebar-blue" id="main-container">
            ...
            <div id="main-content" >
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i>   รายงานข้อมูล RTU ที่ใช้งาน</h1>
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li class="active">รายงานข้อมูล RTU ที่ใช้งาน</li>
                    </ul>
                </div>
                <!-- END Breadcrumb -->
        ...
        <script src="../../../../../javascripts/javascript-home-rmr-reportRTU.js" type="text/javascript"></script>
