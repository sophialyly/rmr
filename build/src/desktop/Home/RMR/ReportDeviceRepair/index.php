...
<html>
    <head>
        <base href="/rmr/build/src/desktop/Home/RMR/ReportDeviceRepair/">
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>RMR - สรุปรายการอุปกรณ์ที่เสีย/ชำรุด</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

        <link href="../../../../../stylesheets/stylesheet-home-rmr-reportDeviceRepair.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="container sidebar-blue" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse sidebar-fixed">
                ...
                <ul class="nav nav-list">
                    ...
                    <!-- END Search Form -->
                        ...
                        <ul class="submenu">
                            <li class="">
                                <a href="../ReportRTU/">รายงานข้อมูล RTU ที่ใช้งาน</a>
                            </li>
                            <li class="active">
                                <a href="../ReportDeviceRepair/">รายการอุปกรณ์เสีย/ชำรุด</a>
                            </li>
                            <li class="">
                                <a href="../ReportCost/">รายงานงบประมาณ</a>
                            </li>
                            <li class="">
                                <a href="../SearchRTU/">สืบค้นข้อมูลแยกตามสาขา</a>
                            </li>
                            <li class="">
                                <a href="../MapDMA/">แผนที่ DMA</a>
                            </li>
                        </ul>
                        <!-- END Submenu -->
                    </li>
            ...
            <div id="main-content" >
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i>   รายการอุปกรณ์ที่เสีย/ชำรุด</h1>
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li class="active">รายการอุปกรณ์ที่เสีย/ชำรุด</li>
                    </ul>
                </div>
                <!-- END Breadcrumb -->
        ...
        <script src="../../../../../javascripts/javascript-home-rmr-reportDeviceRepair.js" type="text/javascript"></script>
