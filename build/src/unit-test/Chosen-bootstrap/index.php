...
<html>
    <head>
        ...
        <title>ทดสอบใช้งาน Chosen-bootstrap</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

        <link href="../../../stylesheets/stylesheet-unit-test-chosen-bootstrap.css" rel="stylesheet" type="text/css" />
    ...
    <div class="container">
      ...
      <div class="side-by-side clearfix">
        ...
        <script src="../../../javascripts/javascript-unit-test-chosen-bootstrap.js" type="text/javascript"></script>
